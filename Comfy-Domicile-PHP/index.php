...
<div id="page-wrapper">
    <div class="row"> 
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="property.php">Buy or Rent homes</a></h5>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="property.php">Find your future home</a></h5>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="feature.php">List your own Properties</a></h5>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="agent.php">Experienced Landlords</a></h5>
                                <p>Find an agent/landlord who knows your market best</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Search for the property, view images and details, contact owner and discuss about the peroperty</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Talk about availabilty, check authenticity of the property legal documents.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>You have the propety, whether for rent or for sale or lease.</p>
                        </div>
                    </div>
                </div>
            </div>
		...
		<!--	Testonomial -->
        	...
        	<!-- Logo Carousel Begin -->
        <div class="logo-carousel full-row">
            <div class="container">
                <div class="lc-slider owl-carousel">
                    <a href="#" class="lc-item">
                        <div class="lc-item-inner">
                            <img src="images/logo-carousel/lc-1.jpg" alt="">
                        </div>
                    </a>
                    <a href="#" class="lc-item">
                        <div class="lc-item-inner">
                            <img src="images/logo-carousel/lc-2.jpg" alt="">
                        </div>
                    </a>
                    <a href="#" class="lc-item">
                        <div class="lc-item-inner">
                            <img src="images/logo-carousel/lc-3.png" alt="">
                        </div>
                    </a>
                    <a href="#" class="lc-item">
                        <div class="lc-item-inner">
                            <img src="images/logo-carousel/lc-4.jpg" alt="">
                        </div>
                    </a>
                    <a href="#" class="lc-item">
                        <div class="lc-item-inner">
                            <img src="images/logo-carousel/lc-5.png" alt="">
                        </div>
                    </a>
                    <a href="#" class="lc-item">
                        <div class="lc-item-inner">
                            <img src="images/logo-carousel/lc-6.jpg" alt="">
                        </div>
                    </a>
                </div>
            </div>
